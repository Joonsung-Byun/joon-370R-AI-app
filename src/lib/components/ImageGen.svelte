...
<div class="container mx-auto max-w-4xl p-4">
    <div class="mb-8 rounded-lg bg-gray-800 p-6 shadow-lg">
        ...
        <div class="mb-6 space-y-4">
            <div>
                <label for="image-prompt" class="block text-sm font-medium text-gray-200 mb-2">
                    Enter your prompt
                </label>
                <textarea
                    id="image-prompt"
            ...
            <button
                ...
                class="inline-flex items-center justify-center gap-2 rounded-md bg-primary-600 px-4 py-2 font-bold text-white transition duration-200 hover:bg-purple-700 disabled:bg-gray-400"
            >
                <Wand size={18} />
